...
//	byte[] mBaudrateBuffer={0x32,0x00,(byte) (mBaudrate & 0xFF),(byte) ((mBaudrate>>8) & 0xFF),(byte) ((mBaudrate>>16) & 0xFF),0x00};;
    ...
    public void onCreateProcess()
    {
        ...
        mScanDeviceDialog = new AlertDialog.Builder(mainContext, R.style.Base_V21_Theme_AppCompat_Dialog)
                .setTitle(R.string.title_devices).setAdapter(mLeDeviceListAdapter, new DialogInterface.OnClickListener() {
